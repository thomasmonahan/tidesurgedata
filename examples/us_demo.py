...
def build_recipe(lat: float, lon: float) -> Recipe:
    ...
    """
    noaa_meta = _nearest_station(NOAACoops, lat, lon, NOAA_SEARCH_RADIUS_KM, "water_level")
    usgs_meta = _nearest_station(USGS, lat, lon, USGS_SEARCH_RADIUS_KM, "discharge")
    ...
    pressure_forecast = Dynamical(DYNAMICAL_FORECAST_DATASET, DYNAMICAL_VARIABLE, lat=lat, lon=lon)
